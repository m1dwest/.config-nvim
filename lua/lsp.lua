vim.lsp.config("clangd", {
	cmd = { "clangd-21", "--background-index", "--clang-tidy", "--fallback-style=google" },
...
vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function(args)
		...
		if client and client.name == "rust-analyzer" and client.server_capabilities.inlayHintProvider then
...
end, { desc = "Show the status of active language servers" })
